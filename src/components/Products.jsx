        ...
        <Offcanvas show={show} onHide={handleClose} placement='end'>
          ...
          <Offcanvas.Body>
            ...
            <div className='d-flex justify-content-between'>
              <Button variant='danger' disabled={cartItems.length === 0} className='' onClick={() => clearCart()}>Clear Cart</Button>
              <Button variant='success' disabled={cartItems.length === 0} className='' onClick={() => checkout()}>Checkout</Button>
            </div>
          </Offcanvas.Body>
        </Offcanvas>
        {loading &&
